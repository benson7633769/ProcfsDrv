...
char stringforuserglobal[PROCFS_MAX_SIZE]; 
...
{ 
    ...
    char tempstringforuser[PROCFS_MAX_SIZE]; 
    ...
    *off += procfs_buffer_size; 
    ...
    snprintf(tempstringforuser, PROCFS_MAX_SIZE, "\tThreadID:%s Time:%llu(ms) context switch times:%lu\n", procfs_buffer, uutime, current->nvcsw+current->nivcsw);
    strcat(stringforuserglobal,tempstringforuser);
